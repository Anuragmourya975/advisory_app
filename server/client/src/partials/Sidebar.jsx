      ...
      >
        ...
        <div className="flex justify-between mb-10 pr-3 sm:px-2">
          ...
          <NavLink end to="/" className="block">
            <img width="32" height="32" src="https://appstock.vidzai.com/static/media/sasya_logo.82957723b68c9aa5f1ca.png"/>
          </NavLink>
        </div>
        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <ul className="mt-3">
              ...
              {/* Farmer */}
              <SidebarLinkGroup activecondition={pathname.includes('farmer')}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <a
                        href="/farmer"
                        className={`block text-slate-200 truncate transition duration-150 ${
                          pathname.includes('farmer') ? 'hover:text-slate-200' : 'hover:text-white'
                        }`}
                        // onClick={(e) => {
                        //   e.preventDefault();
                        //   sidebarExpanded ? handleClick() : setSidebarExpanded(true);
                      ...
                      >
                        <div className="flex items-center justify-between">
                          <div className="flex items-center">
                            <svg className="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                              <path
                                className={`fill-current ${pathname.includes('farmer') ? 'text-indigo-500' : 'text-slate-600'}`}
                                d="M18.974 8H22a2 2 0 012 2v6h-2v5a1 1 0 01-1 1h-2a1 1 0 01-1-1v-5h-2v-6a2 2 0 012-2h.974zM20 7a2 2 0 11-.001-3.999A2 2 0 0120 7zM2.974 8H6a2 2 0 012 2v6H6v5a1 1 0 01-1 1H3a1 1 0 01-1-1v-5H0v-6a2 2 0 012-2h.974zM4 7a2 2 0 11-.001-3.999A2 2 0 014 7z"
                              />
                              <path
                                className={`fill-current ${pathname.includes('farmer') ? 'text-indigo-300' : 'text-slate-400'}`}
